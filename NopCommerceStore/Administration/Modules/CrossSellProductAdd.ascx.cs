...
{
    public partial class CrossSellProductAddControl : BaseNopAdministrationUserControl
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
                ...
                foreach (GridViewRow row in gvProducts.Rows)
                {
                    try
                    {
                        ...
                        if (cbProductInfo.Checked)
                        {
                            ...
                            {
                                IoCFactory.Resolve<IProductManager>().InsertCrossSellProduct(
            ...
            this.Page.ClientScript.RegisterStartupScript(typeof(CrossSellProductAddControl), "closerefresh", "<script language=javascript>try {window.opener.document.forms[0]." + this.BtnId + ".click();}catch (e){} window.close();</script>");
        }
