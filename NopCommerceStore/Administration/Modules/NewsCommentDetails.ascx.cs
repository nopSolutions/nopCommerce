...
namespace NopSolutions.NopCommerce.Web.Administration.Modules
{
    public partial class NewsCommentDetailsControl : BaseNopAdministrationUserControl
    {
        ...
        {
            NewsComment newsComment = this.NewsService.GetNewsCommentById(this.NewsCommentId);
            if (newsComment != null)
            {
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    if (newsComment != null)
                    {
                        ...
                        this.NewsService.UpdateNewsComment(newsComment);
        ...
        {
            this.NewsService.DeleteNewsComment(this.NewsCommentId);
            Response.Redirect("NewsComments.aspx");
        }
