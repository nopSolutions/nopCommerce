...
<div class="section-header">
    <div class="title">
        ...
        <%=GetLocaleResourceString("Admin.ManufacturerDetails.Title")%> - <asp:Label runat="server" ID="lblTitle" />
    ...
    <div class="options">
        ...
        <asp:Button ID="SaveAndStayButton" runat="server" CssClass="adminButtonBlue" Text="<% $NopResources:Admin.ManufacturerDetails.SaveAndStayButton.Text %>"
