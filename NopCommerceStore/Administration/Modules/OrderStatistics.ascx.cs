...
namespace NopSolutions.NopCommerce.Web.Administration.Modules
{
    public partial class OrderStatisticsControl : BaseNopAdministrationUserControl
    {
        ...
        {
            //pending
            var orders_os_pending = IoC.Resolve<IOrderService>().GetOrderReport(OrderStatusEnum.Pending, null, null);
            ...
            //not paid
            var orders_ps_pending = IoC.Resolve<IOrderService>().GetOrderReport(null, PaymentStatusEnum.Pending, null);
            ...
            //not shipped
            var orders_ss_pending = IoC.Resolve<IOrderService>().GetOrderReport(null, null, ShippingStatusEnum.NotYetShipped);
