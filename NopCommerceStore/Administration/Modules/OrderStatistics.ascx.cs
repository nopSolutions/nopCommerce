...
namespace NopSolutions.NopCommerce.Web.Administration.Modules
{
    public partial class OrderStatisticsControl : BaseNopAdministrationUserControl
    {
        ...
        {
            //pending
            var orders_os_pending = this.OrderService.GetOrderReport(OrderStatusEnum.Pending, null, null);
            ...
            //not paid
            var orders_ps_pending = this.OrderService.GetOrderReport(null, PaymentStatusEnum.Pending, null);
            ...
            //not shipped
            var orders_ss_pending = this.OrderService.GetOrderReport(null, null, ShippingStatusEnum.NotYetShipped);
