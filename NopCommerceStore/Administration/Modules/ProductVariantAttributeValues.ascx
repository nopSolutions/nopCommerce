    ...
    <tr>
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtNewPriceAdjustment"
                ...
                ValidationGroup="NewProductVariantAttributeValue"></nopCommerce:DecimalTextBox> [<%=IoC.Resolve<ICurrencyService>().PrimaryStoreCurrency.CurrencyCode%>]
        </td>
    </tr>
    <tr>
        <td class="adminTitle">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtNewWeightAdjustment"
                ...
                ValidationGroup="NewProductVariantAttributeValue"></nopCommerce:DecimalTextBox> [<%=IoC.Resolve<IMeasureService>().BaseWeightIn.Name%>]
        </td>
    </tr>
    <tr>
        <td class="adminTitle">
