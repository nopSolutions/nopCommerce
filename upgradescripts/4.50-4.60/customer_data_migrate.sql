...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'FirstName'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'LastName'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'Gender'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'Company'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'StreetAddress'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'StreetAddress2'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'ZipPostalCode'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'City'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'County'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'Phone'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'Fax'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'VatNumber'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'TimeZoneId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'CustomCustomerAttributesXML'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'CountryId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'StateProvinceId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'VatNumberStatusId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'CurrencyId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'LanguageId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'TaxDisplayTypeId'
...
DELETE GenericAttribute where [KeyGroup] = 'Customer' AND [Key] = 'DateOfBirth'