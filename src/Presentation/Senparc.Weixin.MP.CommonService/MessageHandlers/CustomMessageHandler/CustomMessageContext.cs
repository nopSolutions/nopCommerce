...
namespace Senparc.Weixin.MP.CommonService.CustomMessageHandler
{
    ...
    public class CustomMessageContext : DefaultMpMessageContext  //MessageContext<IRequestMessageBase, IResponseMessageBase>
    {
        ...
        /// <param name="e"></param>
        private void CustomMessageContext_MessageContextRemoved(object sender, Senparc.NeuChar.Context.WeixinContextRemovedEventArgs<IRequestMessageBase, IResponseMessageBase> e)
        {
