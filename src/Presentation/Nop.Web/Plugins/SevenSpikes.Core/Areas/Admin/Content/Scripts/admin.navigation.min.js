                ...
                case 7:
                    {
                        ...
                        // items without a title are not part of the side navigation i.e Logout, Public Store.
                        if (!title) { break; }
                        ...
                        grandParent = $(parents).eq(4).find("a").find("p").html();
                        grandParent = grandParent.substring(0, grandParent.indexOf("<i class"));
                        greatGrandParent = $(parents).eq(6).find("a").find("p").html();
                        greatGrandParent = greatGrandParent.substring(0, greatGrandParent.indexOf("<i class"));
