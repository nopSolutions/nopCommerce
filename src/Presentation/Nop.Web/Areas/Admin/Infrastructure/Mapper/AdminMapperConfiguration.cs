...
#pragma warning restore CS0618
    ...
    protected virtual void CreateOrdersMaps()
    {
        ...
        CreateMap<OrderSettings, OrderSettingsModel>()
            ...
            .ForMember(model => model.AutoCancelUnpaidOrdersEnabled_OverrideForStore, options => options.Ignore())
            .ForMember(model => model.AutoCancelUnpaidOrdersDelay_OverrideForStore, options => options.Ignore())
            ...
            .ForMember(model => model.IgnorePaymentMethods_OverrideForStore, options => options.Ignore())
            ...
            .ForMember(model => model.PrimaryStoreCurrencyCode, options => options.Ignore())
            .ForMember(model => model.RestoreCartAfterCancellation_OverrideForStore, options => options.Ignore())
            ...
            .ForMember(model => model.SelectedPaymentMethods, options => options.Ignore());
