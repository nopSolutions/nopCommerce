    ...
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                captchaSettings.ShowOnGuestCheckout = model.CaptchaSettings.ShowOnGuestCheckout;
                ...
                await _settingService.SaveSettingOverridablePerStoreAsync(captchaSettings, x => x.ShowOnGuestCheckout, model.CaptchaSettings.ShowOnGuestCheckout_OverrideForStore, storeScope, false);
