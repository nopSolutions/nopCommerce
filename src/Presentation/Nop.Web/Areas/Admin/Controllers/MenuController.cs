...
public partial class MenuController : BaseAdminController
{
    ...
    protected virtual async Task<MenuItem> SaveMenuItemAsync(Menu menu, MenuItemModel model, Func<MenuItem, Task> serviceAction)
    {
    ...
    public virtual async Task<IActionResult> MenuItemCreate(MenuItemModel model, bool continueEditing)
    {
        ...
        if (ModelState.IsValid)
        {
            var menuItem = await SaveMenuItemAsync(menu, model, _menuService.InsertMenuItemAsync);
    ...
    public virtual async Task<IActionResult> MenuItemEdit(MenuItemModel model, bool continueEditing)
    {
        ...
        if (ModelState.IsValid)
        {
            menuItem = await SaveMenuItemAsync(menu, model, _menuService.UpdateMenuItemAsync);
