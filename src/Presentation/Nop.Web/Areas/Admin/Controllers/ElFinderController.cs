...
public partial class ElFinderController : BaseAdminController
{
    ...
    [CheckPermission(StandardPermission.System.HTML_EDITOR_MANAGE_PICTURES, CheckPermissionAttribute.CheckPermissionResultType.Json)]
    public virtual async Task<IActionResult> Connector()
    {
        try
        {
            ...
            var connector = _elFinderService.GetConnector(store.Id);
