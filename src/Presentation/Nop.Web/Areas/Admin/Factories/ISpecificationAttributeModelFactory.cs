...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public interface ISpecificationAttributeModelFactory
    {
        ...
        SpecificationAttributeSearchModel PrepareSpecificationAttributeSearchModel(
            SpecificationAttributeSearchModel searchModel);
        ...
        SpecificationAttributeListModel PrepareSpecificationAttributeListModel(
            SpecificationAttributeSearchModel searchModel);
        ...
        SpecificationAttributeOptionModel PrepareSpecificationAttributeOptionModel(
            SpecificationAttributeOptionModel model,
            SpecificationAttribute specificationAttribute, SpecificationAttributeOption specificationAttributeOption,
            ool excludeProperties = false);
