...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IVendorModelFactory
    {
        ...
        Task<VendorSearchModel> PrepareVendorSearchModel(VendorSearchModel searchModel);
        ...
        Task<VendorListModel> PrepareVendorListModel(VendorSearchModel searchModel);
        ...
        Task<VendorModel> PrepareVendorModel(VendorModel model, Vendor vendor, bool excludeProperties = false);
        ...
        Task<VendorNoteListModel> PrepareVendorNoteListModel(VendorNoteSearchModel searchModel, Vendor vendor);
    }
}