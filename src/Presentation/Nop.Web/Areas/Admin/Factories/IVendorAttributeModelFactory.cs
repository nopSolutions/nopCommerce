...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IVendorAttributeModelFactory
    {
        ...
        Task<VendorAttributeSearchModel> PrepareVendorAttributeSearchModel(VendorAttributeSearchModel searchModel);
        ...
        Task<VendorAttributeListModel> PrepareVendorAttributeListModel(VendorAttributeSearchModel searchModel);
        ...
        Task<VendorAttributeModel> PrepareVendorAttributeModel(VendorAttributeModel model,
        ...
        Task<VendorAttributeValueListModel> PrepareVendorAttributeValueListModel(VendorAttributeValueSearchModel searchModel,
        ...
        Task<VendorAttributeValueModel> PrepareVendorAttributeValueModel(VendorAttributeValueModel model,
