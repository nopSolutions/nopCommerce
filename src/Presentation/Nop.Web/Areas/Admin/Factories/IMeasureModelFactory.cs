...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IMeasureModelFactory
    {
        ...
        Task<MeasureSearchModel> PrepareMeasureSearchModel(MeasureSearchModel searchModel);
        ...
        Task<MeasureDimensionListModel> PrepareMeasureDimensionListModel(MeasureDimensionSearchModel searchModel);
        ...
        Task<MeasureWeightListModel> PrepareMeasureWeightListModel(MeasureWeightSearchModel searchModel);
    }
}