...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class NewsletterSubscriptionModelFactory : INewsletterSubscriptionModelFactory
    {
        ...
        public virtual async Task<NewsletterSubscriptionSearchModel> PrepareNewsletterSubscriptionSearchModel(NewsletterSubscriptionSearchModel searchModel)
        {
            if (searchModel == null)
            ...
            await _baseAdminModelFactory.PrepareCustomerRoles(searchModel.AvailableCustomerRoles);
        ...
        public virtual async Task<NewsletterSubscriptionListModel> PrepareNewsletterSubscriptionListModel(NewsletterSubscriptionSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            var newsletterSubscriptions = await _newsLetterSubscriptionService.GetAllNewsLetterSubscriptions(email: searchModel.SearchEmail,
