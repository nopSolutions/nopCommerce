...
public partial interface IProductModelFactory
{
    ...
    /// <summary>
    /// Prepare tagget product list model
    /// </summary>
    /// <param name="searchModel">Product search model</param>
    /// <returns>
    /// A task that represents the asynchronous operation
    /// The task result contains list model for the tagget products
    /// </returns>
    Task<ProductListModel> PrepareTaggedProductListModelAsync(ProductTagProductSearchModel searchModel);
