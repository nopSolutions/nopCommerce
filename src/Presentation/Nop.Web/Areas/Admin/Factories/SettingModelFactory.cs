    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        public virtual async Task<CatalogSettingsModel> PrepareCatalogSettingsModelAsync(CatalogSettingsModel model = null)
        {
            ...
            if (storeId > 0)
            {
                ...
                model.ShowShortDescriptionInGridViewProductBox_OverrideForStore = await _settingService.SettingExistsAsync(catalogSettings, x => x.ShowShortDescriptionInGridViewProductBox, storeId);
