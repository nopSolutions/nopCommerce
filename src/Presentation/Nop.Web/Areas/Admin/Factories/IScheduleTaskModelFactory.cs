...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IScheduleTaskModelFactory
    {
        ...
        Task<ScheduleTaskSearchModel> PrepareScheduleTaskSearchModel(ScheduleTaskSearchModel searchModel);
        ...
        Task<ScheduleTaskListModel> PrepareScheduleTaskListModel(ScheduleTaskSearchModel searchModel);
    }
}