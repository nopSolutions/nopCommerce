...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    public partial record ShippingSettingsModel : BaseNopModel, ISettingsModel
    {
        ...
        public int SortShippingMethodsBy { get; set; }
        public bool SortShippingMethodsBy_OverrideForStore { get; set; }
        public SelectList SortShippingMethodsByValues { get; set; }
