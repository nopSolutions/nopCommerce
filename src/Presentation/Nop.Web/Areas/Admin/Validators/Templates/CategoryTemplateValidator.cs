...
public partial class CategoryTemplateValidator : BaseNopValidator<CategoryTemplateModel>
{
    ...
    {
        RuleFor(x => x.Name).NotEmpty().WithMessage("Admin.System.Templates.Category.Name.Required");
        RuleFor(x => x.ViewPath).NotEmpty().WithMessage("Admin.System.Templates.Category.ViewPath.Required");
