...
public partial class TopicTemplateValidator : BaseNopValidator<TopicTemplateModel>
{
    ...
    {
        RuleFor(x => x.Name).NotEmpty().WithMessage("Admin.System.Templates.Topic.Name.Required");
        RuleFor(x => x.ViewPath).NotEmpty().WithMessage("Admin.System.Templates.Topic.ViewPath.Required");
