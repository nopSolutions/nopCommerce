...
namespace Nop.Web.Factories
{
    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
        ...
        protected virtual async Task PrepareCustomAddressAttributes(AddressModel model,
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (!excludeProperties && address != null)
            {
                ...
                model.CountryName = await _countryService.GetCountryByAddress(address) is Country country ? await _localizationService.GetLocalized(country, x => x.Name) : null;
                model.StateProvinceId = address.StateProvinceId;
                model.StateProvinceName = await _stateProvinceService.GetStateProvinceByAddress(address) is StateProvince stateProvince ? await _localizationService.GetLocalized(stateProvince, x => x.Name) : null;
            ...
            if (addressSettings.CountryEnabled && loadCountries != null)
            {
                ...
                {
                    var languageId = (await EngineContext.Current.Resolve<IWorkContext>().GetWorkingLanguage()).Id;
