...
namespace Nop.Web.Factories
{
    ...
    public partial interface IVendorModelFactory
    {
        ...
        Task<ApplyVendorModel> PrepareApplyVendorModel(ApplyVendorModel model, bool validateVendor, bool excludeProperties, string vendorAttributesXml);
        ...
        Task<VendorInfoModel> PrepareVendorInfoModel(VendorInfoModel model, bool excludeProperties, string overriddenVendorAttributesXml = "");
    }
}