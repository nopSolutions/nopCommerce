...
namespace Nop.Web.Factories
{
    ...
    public partial interface IReturnRequestModelFactory
    {
        ...
        Task<SubmitReturnRequestModel.OrderItemModel> PrepareSubmitReturnRequestOrderItemModel(OrderItem orderItem);
        ...
        Task<SubmitReturnRequestModel> PrepareSubmitReturnRequestModel(SubmitReturnRequestModel model, Order order);

        /// <summary>
        /// Prepare the customer return requests model
        /// </summary>
        /// <returns>Customer return requests model</returns>
        Task<CustomerReturnRequestsModel> PrepareCustomerReturnRequestsModel();
    }
}
