...
namespace Nop.Web.Factories
{
    ...
    public partial interface ITopicModelFactory
    {
        ...
        Task<TopicModel> PrepareTopicModelById(int topicId, bool showHidden = false);
        ...
        /// <returns>Topic model</returns>
        Task<TopicModel> PrepareTopicModelBySystemName(string systemName);
        ...
        Task<string> PrepareTemplateViewPath(int topicTemplateId);
    }
}
