    ...
    addShippingOption: function (name, deliveryDate, price) {
      ...
      shippingOption
        .append($('<div/>').addClass('estimate-shipping-row-item-radio')
          .append($('<label/>').addClass('forcheckbox')
          .append($('<input/>').addClass('estimate-shipping-radio').attr({ 'type': 'radio', 'name': 'shipping-option' + '-' + this.settings.contentEl }))
            .append($('<div/>').addClass('circle')
              .append($('<div/>').addClass('circle--inner circle--inner__1'))
              .append($('<div/>').addClass('circle--inner circle--inner__2'))
              .append($('<div/>').addClass('circle--inner circle--inner__3'))
              .append($('<div/>').addClass('circle--inner circle--inner__4'))
              .append($('<div/>').addClass('circle--inner circle--inner__5'))
              .append($('<div/>').addClass('circle--outer'))
