/*
** ABC Warehouse ajax cart
**
** this enhances functionality of nopCommerce's implementation
** and is referenced in Misc.AbcFrontend
*/
    ...
    success_process: function (response) {
        ...
        if (response.message) {
            ...
            if (response.success === true) {
                ...
                //base functionality
                else if (AjaxCart.usepopupnotifications === true) {
