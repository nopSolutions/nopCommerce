...
public partial class CustomerInfoValidator : BaseNopValidator<CustomerInfoModel>
{
        ...
        TaxSettings taxSettings)
    {
        ...
        if (customerSettings.FirstNameEnabled && customerSettings.FirstNameRequired) RuleFor(x => x.FirstName).NotEmpty().WithMessageAwait(localizationService.GetResourceAsync("Account.Fields.FirstName.Required"));
        if (customerSettings.LastNameEnabled && customerSettings.LastNameRequired) RuleFor(x => x.LastName).NotEmpty().WithMessageAwait(localizationService.GetResourceAsync("Account.Fields.LastName.Required"));
