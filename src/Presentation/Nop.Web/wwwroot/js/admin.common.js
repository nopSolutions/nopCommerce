...
$(function() {
    $('[data-bs-dismiss]').each(function () {
        $(this).attr('data-bs-dismiss', $(this).attr('data-bs-dismiss')).removeAttr('data-bs-dismiss');
    });
...
function bindBootstrapTabSelectEvent(tabsId, inputId) {
  $('#' + tabsId + ' > div ul li a[data-bs-toggle="pill"], #' + tabsId + ' > div ul li a[data-bs-toggle="pill"]').on('shown.bs.tab', function (e) {
