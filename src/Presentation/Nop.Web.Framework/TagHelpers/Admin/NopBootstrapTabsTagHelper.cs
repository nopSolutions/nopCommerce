...
{
    [HtmlTargetElement("nop-bootstrap-tabs", Attributes = IdAttributeName)]
    public class NopBootstrapTabsTagHelper : TagHelper
    {
        ...
        public NopBootstrapTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            context.Items.Add(typeof(NopBootstrapTabsTagHelper), tabContext);
    ...
    [HtmlTargetElement("nop-tab", ParentTag = "nop-bootstrap-tabs", Attributes = NameAttributeName)]
    public class NopTabTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<NopTabContextItem>)context.Items[typeof(NopBootstrapTabsTagHelper)];
