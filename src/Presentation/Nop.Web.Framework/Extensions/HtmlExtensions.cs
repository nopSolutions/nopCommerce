...
namespace Nop.Web.Framework.Extensions
{
    ...
    public static class HtmlExtensions
    {
        ...
        public static async Task<IHtmlContent> LocalizedEditor<TModel, TLocalizedModelLocal>(this IHtmlHelper<TModel> helper,
            string name,
            ...
            where TLocalizedModelLocal : ILocalizedLocaleModel
        {
            ...
            var tabNameToSelect = await GetSelectedTabName(helper, name);
            ...
            tabStrip.AppendLine($"<a data-tab-name=\"{standardTabName}\" href=\"#{standardTabName}\" data-toggle=\"tab\">{await localizationService.GetResource("Admin.Common.Standard")}</a>");
        ...
        public static Task<string> GetSelectedPanelName(this IHtmlHelper helper)
        {
            ...
            if (helper.ViewData.ContainsKey(dataKey))
                panelName = helper.ViewData[dataKey].ToString();
        ...
        /// <returns>Name</returns>
        public static Task<string> GetSelectedTabName(this IHtmlHelper helper, string dataKeyPrefix = null)
        {
            //keep this method synchronized with
