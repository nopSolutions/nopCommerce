    ...
    public sealed class NopResourceDisplayNameAttribute : DisplayNameAttribute, IModelAttribute
    {
        ...
        public override string DisplayName
        {
            get
            {
                ...
                var workingLanguageId = EngineContext.Current.Resolve<IWorkContext>().GetWorkingLanguage().Result.Id;

                //get locale resource value
                _resourceValue = EngineContext.Current.Resolve<ILocalizationService>().GetResource(ResourceKey, workingLanguageId, true, ResourceKey).Result;
