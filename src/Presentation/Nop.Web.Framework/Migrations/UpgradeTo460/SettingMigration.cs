...
public class SettingMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        foreach (var store in synchronousCodeHelper.GetAllEntities<Store>(query => query.OrderBy(s => s.DisplayOrder).ThenBy(s => s.Id), _ => default, includeDeleted: false))
        {
            ...
            synchronousCodeHelper.UpdateEntity(store);
        }
