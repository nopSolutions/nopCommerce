...
public class SettingMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        //#7397
        this.DeleteSettingsByNames(["adminareasettings.richeditorallowjavascript", "adminareasettings.richeditorallowstyletag"]);
        this.SetSettingIfNotExists<AdminAreaSettings, string>(settings => settings.RichEditorAdditionalSettings, string.Empty);
