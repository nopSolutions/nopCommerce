...
namespace Nop.Web.Framework.Factories
{
    ...
    public partial interface IAclSupportedModelFactory
    {
        ...
        Task PrepareModelCustomerRoles<TModel>(TModel model) where TModel : IAclSupportedModel;
        ...
        Task PrepareModelCustomerRoles<TModel, TEntity>(TModel model, TEntity entity, bool ignoreAclMappings)
