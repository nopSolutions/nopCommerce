...
namespace Nop.Web.Framework.Factories
{
    ...
    public partial class DiscountSupportedModelFactory : IDiscountSupportedModelFactory
    {
        ...
        virtual public Task<TModel> PrepareModelDiscountsAsync<TModel>(TModel model, IList<Discount> availableDiscounts) where TModel : IDiscountSupportedModel
        {
            if (model == null)
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        async virtual public Task<TModel> PrepareModelDiscountsAsync<TModel, TMapping>(TModel model, IDiscountSupported<TMapping> entity,
