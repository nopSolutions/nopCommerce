...
namespace Nop.Core.Domain.Customers
{
    public static class CustomerExtentions
    {
        ...
        {
            string serializedGiftCartCouponCodes = customer.GiftCardCouponCodes;
        ...
        public static void ApplyGiftCardCouponCode(this Customer customer, string couponCode)
        {
            ...
            try
            {
                var serializedGiftCartCouponCodes = customer.GiftCardCouponCodes;
            ...
            //apply new value
            customer.GiftCardCouponCodes = result;
        }
