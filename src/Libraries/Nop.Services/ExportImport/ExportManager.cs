...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public ExportManager(ICategoryService categoryService, StoreInformationSettings storeInformationSettings)
        {
        ...
        {
            var categories = _categoryService.GetAllCategoriesByParentCategoryId(parentCategoryId);//IoC.Resolve<ICategoryService>().GetAllCategoriesByParentCategoryId(parentCategoryId);
        ...
        public string ExportCustomersToXml(List<Customer> customers)
        {
            ...
            foreach (var customer in customers)
            {
                ...
                //TODO:Implement export customers to xml
                #region TODO
        ...
        public void ExportCustomersToXls(string filePath, List<Customer> customers)
        {
            ...
            {
                //TODO:Implement export customers to xls
                #region TODO
        ...
        public void ExportProductsToXls(string filePath, List<Product> products)
        {
            using (ExcelHelper excelHelper = new ExcelHelper(filePath))
            {
                //TODO:Implement export products to xls
                #region TODO
        ...
        public void ExportOrdersToXls(string filePath, List<Order> orders)
        {
            using (ExcelHelper excelHelper = new ExcelHelper(filePath))
            {
                //TODO:Implement export orders to xls
                #region TODO
        ...
        public string ExportMessageTokensToXml()
        {
            ...
            string[] allowedTokens = new string[0];//TODO:Get IoC.Resolve<IMessageService>().GetListOfAllowedTokens();
