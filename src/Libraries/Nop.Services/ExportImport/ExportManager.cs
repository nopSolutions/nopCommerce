...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        {
            return ExportToXlsx(new ManufacturerGetProperties(_pictureService), manufacturers);
        }
        ...
        /// <returns></returns>
        public virtual byte[] ExportToXlsx<T>(IGetProperties<T> getProperty, IEnumerable<T> itemsToExport)
        {
            using (var stream = new MemoryStream())
            {
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    var manager = new PropertyManager<T>(getProperty.GetProperties);
        ...
        {
            return ExportToXlsx(new CategoryGetProperties(_pictureService), categories);
        }
        ...
        {
            return ExportToXlsx(new ProductGetProperties(_pictureService, _categoryService, _manufacturerService), products);
        }
