...
namespace Nop.Services.ExportImport.Help
{
    ...
    public class LocalizedPropertyByName<T, L>
    {
        ...
        public LocalizedPropertyByName(string propertyName, Func<T, L, Task<object>> func, bool ignore = false)
        {
        ...
        /// <param name="func">Feature property access</param>
        /// <param name="ignore">Specifies whether the property should be exported</param>
        public LocalizedPropertyByName(string propertyName, Func<T, L, object> func = null, bool ignore = false)
        {
            PropertyName = propertyName;
