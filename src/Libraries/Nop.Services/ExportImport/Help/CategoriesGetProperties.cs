...
namespace Nop.Services.ExportImport.Help
{
    ...
    /// </summary>
    public class CategoriesGetProperties : BaseGetProperties, IGetProperties<Category>
    {
        public CategoriesGetProperties(IPictureService pictureService) : base(pictureService)
        {
        }
        ...
        /// Get property array
        /// </summary>
        public PropertyByName<Category>[] GetPropertys
        {
            get
            {
                return new[]
