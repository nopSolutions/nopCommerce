...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        public virtual void ImportManufacturerFromXlsx(Stream stream)
        {
            ...
            var manager = new PropertyManager<Manufacturer>(properties.GetProperties);

            ImportFromXlsx(stream, manager, properties, new Manufacturer(), GetManufacturer);
        }
        ...
        public virtual void ImportCategoryFromXlsx(Stream stream)
        {
            ...
            var manager = new PropertyManager<Category>(properties.GetProperties);
        ...
        /// <param name="getProperty">Instance of object access through its properties class</param>
            ...
            BaseEntity newObj, Func<int, BaseEntity> getObject)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                while (true)
                {
                    try
                    {
                        var allColumnsAreEmpty = getProperty.GetProperties
