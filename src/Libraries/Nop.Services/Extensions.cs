    ...
    public static class Extensions
    {
           ...
           bool markCurrentAsSelected = true, int[] valuesToExclude = null, bool useLocalization = true) where TEnum : struct
        {
            ...
            var values = from TEnum enumValue in Enum.GetValues(typeof(TEnum))
                         ...
                         select new { ID = Convert.ToInt32(enumValue), Name = useLocalization ? localizationService.GetLocalizedEnumAsync(enumValue).Result : CommonHelper.ConvertEnum(enumValue.ToString()) };
