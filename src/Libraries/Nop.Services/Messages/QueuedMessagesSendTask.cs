...
namespace Nop.Services.Messages
{
    ...
    public partial class QueuedMessagesSendTask : IScheduleTask
    {
        ...
        {
            var maxTries = 3;
            var queuedEmails = await _queuedEmailService.SearchEmails(null, null, null, null,
            ...
            foreach (var queuedEmail in queuedEmails)
            {
                ...
                try
                {
                    await _emailSender.SendEmail(await _emailAccountService.GetEmailAccountById(queuedEmail.EmailAccountId),
                        queuedEmail.Subject,
                        queuedEmail.Body,
                       queuedEmail.From,
