    ...
    public class UploadService : IUploadService
    {
        ...
        public virtual void UploadIconsArchive(IFormFile archivefile)
        {
            ...
            try
            {
                ...
                var storeIconsPath = _fileProvider.GetAbsolutePath(string.Format(NopCommonDefaults.FaviconAndAppIconsPath, AsyncHelper.RunSync(_storeContext.GetActiveStoreScopeConfigurationAsync)));
        ...
        public virtual void UploadFavicon(IFormFile favicon)
        {
            ...
            var storeFaviconPath = _fileProvider.GetAbsolutePath(string.Format(NopCommonDefaults.FaviconAndAppIconsPath, AsyncHelper.RunSync(_storeContext.GetActiveStoreScopeConfigurationAsync)));
