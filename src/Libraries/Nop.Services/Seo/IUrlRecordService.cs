...
namespace Nop.Services.Seo
{
    ...
    public partial interface IUrlRecordService
    {
        ...
        Task<IPagedList<UrlRecord>> GetAllUrlRecords(string slug = "", int? languageId = null, bool? isActive = null, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        Task<string> GetActiveSlug(int entityId, string entityName, int languageId);
        ...
        Task<string> GetSeName(string name, bool convertNonWesternChars, bool allowUnicodeCharsInUrls);
