...
namespace Nop.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        protected static volatile Dictionary<char, string> _seoCharacterTable;
        protected static readonly HashSet<char> _okChars = new("abcdefghijklmnopqrstuvwxyz1234567890 _-");
        ...
        protected virtual void InitializeSeoCharacterTable()
        {
            _seoCharacterTable ??= new Dictionary<char, string>
            {
                ...
                { '\u01BD', "5" }, // LATIN SMALL LETTER TONE FIVE -- no decomposition
                                            //_seoCharacterTable.Add('\u01BE"), "´'; // LATIN LETTER INVERTED GLOTTAL STOP WITH STROKE -- no decomposition
                ...
                //_seoCharacterTable.Add('\u0298"), "O˜'; // LATIN LETTER BILABIAL CLICK -- no decomposition
        ...
        {
            var urlRecords = (await _urlRecordRepository.GetAllAsync(query => query.OrderBy(ur => ur.Slug), cache => default))
                .AsEnumerable();
