...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        Task<(decimal discountAmount, List<Discount> appliedDiscounts, decimal subTotalWithoutDiscount, decimal subTotalWithDiscount, SortedDictionary<decimal, decimal> taxRates)> GetShoppingCartSubTotal(IList<ShoppingCartItem> cart,
            bool includingTax);
        ...
        Task<bool> IsFreeShipping(IList<ShoppingCartItem> cart, decimal? subTotal = null);
        ...
        Task<decimal?> GetShoppingCartShippingTotal(IList<ShoppingCartItem> cart);
        ...
        Task<(decimal? shippingTotal, decimal taxRate, List<Discount> appliedDiscounts)> GetShoppingCartShippingTotal(
        ...
        Task<(decimal? shoppingCartTotal, decimal discountAmount, List<Discount> appliedDiscounts, List<AppliedGiftCard> appliedGiftCards, int redeemedRewardPoints, decimal redeemedRewardPointsAmount)> GetShoppingCartTotal(IList<ShoppingCartItem> cart,
        ...
        Task<int> CalculateRewardPoints(Customer customer, decimal amount);
    }
}
