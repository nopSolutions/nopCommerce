...
public partial class InstallationService
{
    ...
    protected virtual async Task InstallComputersAsync(int productTemplateSimpleId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        var productBuildComputer = new Product
        {
            ...
            Width = 2,
            Height = 2,
            TaxCategoryId = Table<TaxCategory>().Single(tc => tc.Name == "Electronics & Software").Id,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Desktops").Id,
            DisplayOrder = 1
        });
        ...
        {
            ProductId = productBuildComputer.Id,
            ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "Processor").Id,
        ...
        {
            ProductId = productBuildComputer.Id,
            ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "RAM").Id,
            AttributeControlType = AttributeControlType.DropdownList,
            IsRequired = true
        });
        ...
        var pamHdd = await _dataProvider.InsertEntityAsync(
            ...
            {
                ProductId = productBuildComputer.Id,
                ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "HDD").Id,
        ...
        var pamOs = await _dataProvider.InsertEntityAsync(
            ...
            {
                ProductId = productBuildComputer.Id,
                ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "OS").Id,
                AttributeControlType = AttributeControlType.RadioList,
                IsRequired = true
            });
        ...
        {
            ProductId = productBuildComputer.Id,
            ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "Software").Id,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Notebooks").Id,
            DisplayOrder = 1
        });
        ...
        {
            ProductId = productAppleMacBookPro.Id,
            ManufacturerId = Table<Manufacturer>().Single(c => c.Name == "Apple").Id,
            DisplayOrder = 2
        });
        ...
        {
            ProductId = productHpSpectre.Id,
            ManufacturerId = Table<Manufacturer>().Single(c => c.Name == "HP").Id,
            DisplayOrder = 3
        });
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Software").Id,
            DisplayOrder = 1
        });
    ...
    protected virtual async Task InstallElectronicsAsync(int productTemplateSimpleId, int productTemplateGroupedId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Camera & photo").Id,
            DisplayOrder = 1
        });
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Cell phones").Id,
            DisplayOrder = 1
        });
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Others").Id,
            DisplayOrder = 1
        });
    ...
    protected virtual async Task InstallApparelAsync(int productTemplateSimpleId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        ...
        var productNikeFloral = new Product
        {
            ...
            Width = 2,
            Height = 2,
            TaxCategoryId = Table<TaxCategory>().Single(tc => tc.Name == "Apparel").Id,
            ManageInventoryMethod = ManageInventoryMethod.ManageStock,
            StockQuantity = 10000,
            NotifyAdminForQuantityBelow = 1,
            AllowBackInStockSubscriptions = false,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Shoes").Id,
            DisplayOrder = 1
        });
        ...
        {
            ProductId = productNikeFloral.Id,
            ManufacturerId = Table<Manufacturer>().Single(c => c.Name == "Nike").Id,
            DisplayOrder = 2
        });
        ...
        var pamSize = await _dataProvider.InsertEntityAsync(
            ...
            {
                ProductId = productNikeFloral.Id,
                ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "Size").Id,
                AttributeControlType = AttributeControlType.DropdownList,
                IsRequired = true
            });
        ...
        var pamColor = await _dataProvider.InsertEntityAsync(
            ...
            {
                ProductId = productNikeFloral.Id,
                ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "Color").Id,
                AttributeControlType = AttributeControlType.DropdownList,
                IsRequired = true
            });
        ...
        var pamPrint = await _dataProvider.InsertEntityAsync(
            ...
            {
                ProductId = productNikeFloral.Id,
                ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "Print").Id,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Clothing").Id,
            DisplayOrder = 1
        });
        ...
        await _dataProvider.InsertEntityAsync(
            ...
            {
                ProductId = productCustomTShirt.Id,
                ProductAttributeId = Table<ProductAttribute>().Single(x => x.Name == "Custom Text").Id,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Accessories").Id,
            DisplayOrder = 1
        });
    ...
    protected virtual async Task InstallDigitalDownloadsAsync(int productTemplateSimpleId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        ...
        var productNightVision = new Product
        {
            ...
            AllowCustomerReviews = true,
            Price = 2.8M,
            TaxCategoryId = Table<TaxCategory>().Single(tc => tc.Name == "Downloadable Products").Id,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Digital downloads").Id,
            DisplayOrder = 1
        });
    ...
    protected virtual async Task InstallBooksAsync(int productTemplateSimpleId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        var productFahrenheit = new Product
        {
            ...
            Width = 2,
            Height = 2,
            TaxCategoryId = Table<TaxCategory>().Single(tc => tc.Name == "Books").Id,
            ManageInventoryMethod = ManageInventoryMethod.ManageStock,
            StockQuantity = 10000,
            NotifyAdminForQuantityBelow = 1,
            AllowBackInStockSubscriptions = false,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Books").Id,
            DisplayOrder = 1
        });
    ...
    protected virtual async Task InstallJewelryAsync(int productTemplateSimpleId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        var productElegantGemstoneNecklace = new Product
        {
            ...
            Width = 2,
            Height = 2,
            TaxCategoryId = Table<TaxCategory>().Single(tc => tc.Name == "Jewelry").Id,
            ManageInventoryMethod = ManageInventoryMethod.ManageStock,
            StockQuantity = 10000,
            NotifyAdminForQuantityBelow = 1,
            AllowBackInStockSubscriptions = false,
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Jewelry").Id,
            DisplayOrder = 1
        });
    ...
    protected virtual async Task InstallGiftCardsAsync(int productTemplateSimpleId, List<Product> allProducts, List<RelatedProduct> relatedProducts)
    {
        ...
        await _dataProvider.InsertEntityAsync(new ProductCategory
        {
            ...
            CategoryId = Table<Category>().Single(c => c.Name == "Gift Cards").Id,
            DisplayOrder = 2
        });
