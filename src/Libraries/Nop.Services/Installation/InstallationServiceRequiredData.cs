    ...
    public partial class InstallationService : IInstallationService
    {
        ...
        protected virtual async Task InstallStoresAsync()
        {
            ...
            var stores = new List<Store>
            {
                new() {
                    ...
                    CompanyPhoneNumber = "(123) 4567 8901",
                    CompanyVat = null
                }
            };
        ...
        protected virtual async Task InstallMeasuresAsync(RegionInfo regionInfo)
        {
            ...
            var measureDimensions = new List<MeasureDimension>
            {
                ...
                new() {
                    Name = "centimeter(s)",
                    SystemKeyword = "centimeters",
                    Ratio = isMetric ? 100M : 25.4M,
                    DisplayOrder = isMetric ? 0 : 1
                },
                new() {
                    Name = "millimetre(s)",
        ...
        protected virtual async Task InstallTaxCategoriesAsync()
        {
            ...
            {
                new() {Name = "Fragrance", DisplayOrder = 5},
                new() {Name = "Cosmetics", DisplayOrder = 10}
            };
        ...
        protected virtual async Task InstallCurrenciesAsync(CultureInfo cultureInfo, RegionInfo regionInfo)
        {
            ...
            var defaultCurrencies = new List<string>() { "USD", "AUD", "GBP", "CAD", "CNY", "EUR", "HKD", "INR", "JPY", "NZD", "RUB" };
        ...
        protected virtual async Task InstallSettingsAsync(RegionInfo regionInfo)
        {
            ...
            await settingService.SaveSettingAsync(new LocalizationSettings
            {
                DefaultAdminLanguageId =
                    _languageRepository.Table
                        .First(l => l.LanguageCulture == NopCommonDefaults.DefaultLanguageCulture).Id,
            ...
            await settingService.SaveSettingAsync(new CurrencySettings
            {
                ...
                PrimaryStoreCurrencyId =
                    _currencyRepository.Table.First(c => c.CurrencyCode == primaryCurrency).Id,
            ...
            {
                BaseDimensionId =
                    _measureDimensionRepository.Table.First(m => m.SystemKeyword == baseDimension).Id,
                BaseWeightId = _measureWeightRepository.Table.First(m => m.SystemKeyword == baseWeight).Id
            });
            ...
            var topics = new List<Topic>
                {
                    ...
                    new() {
                        ...
                        Title = string.Empty,
                        Body =
                            "<p><strong>The page you requested was not found, and we have a fine guess why.</strong></p><ul><li>If you typed the URL directly, please make sure the spelling is correct.</li><li>The page no longer exists. In this case, we profusely apologize for the inconvenience and for any missed opportunites.</li></ul>",
                        TopicTemplateId = defaultTopicTemplate.Id
                    },
                    new() {
