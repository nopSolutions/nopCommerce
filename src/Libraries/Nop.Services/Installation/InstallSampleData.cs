...
public partial class InstallationService
{
    ...
    {
        var categoryTemplateInGridAndLines = Table<CategoryTemplate>().FirstOrDefault(pt => pt.Name == "Products in Grid or Lines") ?? throw new Exception("Category template cannot be loaded");
    ...
    protected virtual async Task InstallManufacturersAsync()
    {
        var manufacturerTemplateInGridAndLines =
            Table<ManufacturerTemplate>().FirstOrDefault(pt => pt.Name == "Products in Grid or Lines") ?? throw new Exception("Manufacturer template cannot be loaded");
    ...
    protected virtual async Task InstallBlogPostsAsync()
    {
        ...
        await InsertSearchEngineNamesAsync(blogPosts, blogPost => blogPost.Title, DefaultLanguageId);
        
        await _dataProvider.BulkInsertEntitiesAsync(blogPosts.Select(blogPost => new BlogComment
        {
    ...
    protected virtual async Task InstallNewsAsync()
    {
        ...
        await InsertSearchEngineNamesAsync(news, newsItem => newsItem.Title, DefaultLanguageId);

        await _dataProvider.BulkInsertEntitiesAsync(news.Select(newsItem => new NewsComment
        {
    ...
    protected virtual async Task InstallOrdersAsync()
    {
        ...
        var firstOrder = new Order
        {
            ...
            CustomerLanguageId = Table<Language>().First().Id,
        ...
        var thirdOrder = new Order
        {
            ...
            CustomerLanguageId = (await Table<Language>().FirstAsync()).Id,
            CustomerIp = "127.0.0.1",
        ...
        var firstOrderItem1 = new OrderItem
        {
            ...
            ProductId = Table<Product>().First(p => p.Name == "Apple iCam").Id,
        ...
        var firstOrderItem2 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = firstOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "Leica T Mirrorless Digital Camera").Id,
        ...
        var firstOrderItem3 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = firstOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "$25 Virtual Gift Card").Id,
        ...
        var secondOrderItem1 = new OrderItem
        {
            ...
            ProductId = Table<Product>().First(p => p.Name == "Vintage Style Engagement Ring").Id,
        ...
        var secondOrderItem2 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = secondOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "Flower Girl Bracelet").Id,
        ...
        var thirdOrderItem1 = new OrderItem
        {
            ...
            ProductId = Table<Product>().First(p => p.Name == "If You Wait (donation)").Id,
            UnitPriceInclTax = 3M,
            UnitPriceExclTax = 3M,
            PriceInclTax = 3M,
            PriceExclTax = 3M,
        ...
        var thirdOrderItem2 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = thirdOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "Night Visions").Id,
        ...
        var thirdOrderItem3 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = thirdOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "Science & Faith").Id,
            UnitPriceInclTax = 3M,
            UnitPriceExclTax = 3M,
            PriceInclTax = 3M,
            PriceExclTax = 3M,
        ...
        var fourthOrderItem1 = new OrderItem
        {
            ...
            ProductId = Table<Product>().First(p => p.Name == "Pride and Prejudice").Id,
        ...
        var fourthOrderItem2 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = fourthOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "First Prize Pies").Id,
        ...
        var fourthOrderItem3 = new OrderItem
        {
            OrderItemGuid = Guid.NewGuid(),
            OrderId = fourthOrder.Id,
            ProductId = Table<Product>().First(p => p.Name == "Fahrenheit 451 by Ray Bradbury").Id,
        ...
        var fifthOrderItem1 = new OrderItem
        {
            ...
            ProductId = Table<Product>().First(p => p.Name == "Levi's 511 Jeans").Id,
    ...
    protected virtual async Task InstallSearchTermsAsync()
    {
        await _dataProvider.BulkInsertEntitiesAsync(new[]
        {
            new SearchTerm { Count = 34, Keyword = "computer", StoreId = DefaultStoreId },
            new SearchTerm { Count = 30, Keyword = "camera", StoreId = DefaultStoreId },
            new SearchTerm { Count = 27, Keyword = "jewelry", StoreId = DefaultStoreId },
            new SearchTerm { Count = 26, Keyword = "shoes", StoreId = DefaultStoreId },
            new SearchTerm { Count = 19, Keyword = "jeans", StoreId = DefaultStoreId },
            new SearchTerm { Count = 10, Keyword = "gift", StoreId = DefaultStoreId }
        });
    }
    ...
    /// </summary>
    protected virtual int DefaultLanguageId
    {
        get
        {
            ...
            _defaultLanguageId = Table<Language>().FirstOrDefault()?.Id ?? throw new Exception("Default language could not be loaded");
    ...
    /// </summary>
    protected virtual int DefaultStoreId
    {
        get
        {
            ...
            _defaultStoreId = Table<Store>().FirstOrDefault()?.Id ?? throw new Exception("No default store could be loaded");
    ...
    /// </summary>
    protected virtual int DefaultCustomerId
    {
        get
        {
            ...
            _defaultCustomerId = Table<Customer>().FirstOrDefault(x => x.Email == _defaultCustomerEmail)?.Id ?? throw new Exception("Cannot load default customer");
