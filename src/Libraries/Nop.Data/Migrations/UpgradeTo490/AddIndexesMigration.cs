...
public class AddIndexesMigration : ForwardOnlyMigration
{
    ...
    public override void Up()
    {
        ...
        var productCategoryMappingIndexName = "IX_Product_Category_Mapping_CategoryId";
        ...
        var productManufacturerMappingIndexName = "IX_Product_Manufacturer_Mapping_ManufacturerId";
