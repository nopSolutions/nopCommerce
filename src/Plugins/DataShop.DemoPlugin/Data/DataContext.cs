...
namespace DataShop.DemoPlugin.Data
{
    public class DataContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.Configurations.Add(new DemoItemMap());
        ...
        public void Install()
        {
            ...
            item.ProductId = 1;
            item.ProductName = "Build your own computer";

            Set<DemoItem>().Add(item);
        ...
        {
            //var dbScript = "DROP TABLE DemoItems";
            //Database.ExecuteSqlCommand(dbScript);                    
            //this.DropPluginTable("DemoItems");

            //drop the table
            this.DropPluginTable(this.GetTableName<DemoItem>());
            SaveChanges();
        }
