...
public class ViewLocationExpander : IViewLocationExpander
{
    ...
    {
        viewLocations = context.AreaName == AreaNames.ADMIN ? new[] { $"/Plugins/Misc.RFQ/Views/Admin/{context.ViewName}.cshtml" }.Concat(viewLocations) : new[] { $"/Plugins/Misc.RFQ/Views/{context.ViewName}.cshtml" }.Concat(viewLocations);
