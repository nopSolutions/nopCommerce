...
namespace Nop.Plugin.Shipping.FixedByWeightByTotal.Infrastructure.Cache
{
    ...
    public partial class FixedByWeightByTotalEventConsumer : IConsumer<EntityDeletedEvent<ShippingMethod>>
    {
        ...
        public async Task HandleEvent(EntityDeletedEvent<ShippingMethod> eventMessage)
        {
            ...
            var setting = await _settingService.GetSetting(string.Format(FixedByWeightByTotalDefaults.FixedRateSettingsKey, shippingMethod.Id));
            if (setting != null)
