...
public class CloudflareImagesHttpClient
{
    ...
    private readonly CloudflareImagesConfig _config;
    ...
    public CloudflareImagesHttpClient(AppSettings appSettings, HttpClient httpClient)
    {
        _config = appSettings.Get<CloudflareImagesConfig>();
        httpClient.Timeout = TimeSpan.FromSeconds(_config.RequestTimeout ?? CloudflareImagesDefaults.RequestTimeout);
    ...
    private async Task<string> RequestAsync(string apiUri = "", HttpContent data = null, HttpMethod httpMethod = null)
    {
        ...
        request.Headers.TryAddWithoutValidation(HeaderNames.Authorization, $"Bearer {_config.AccessToken}");
