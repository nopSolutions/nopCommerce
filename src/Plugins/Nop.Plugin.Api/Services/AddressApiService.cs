...
namespace Nop.Plugin.Api.Services
{
	public class AddressApiService : IAddressApiService
	{
        ...
        public async Task<IList<AddressDto>> GetAddressesByCustomerIdAsync(int customerId)
        {
            ...
            var key = _cacheManager.PrepareKeyForDefaultCache(NopCustomerServicesDefaults.CustomerAddressesCacheKey, customerId);
		...
		public async Task<AddressDto> GetCustomerAddressAsync(int customerId, int addressId)
        {
            ...
            var key = _cacheManager.PrepareKeyForDefaultCache(NopCustomerServicesDefaults.CustomerAddressCacheKey, customerId, addressId);
