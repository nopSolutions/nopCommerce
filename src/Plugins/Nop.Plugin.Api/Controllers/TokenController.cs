...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class TokenController : Controller
    {
        ...
        public async Task<IActionResult> Create([FromBody] TokenRequest model)
        {
            ...
            newCustomer = await LoginAsync(model.Username, model.Password, true);
            ...
            await _authenticationService.SignInAsync(newCustomer, true); // update cookie-based authentication - not needed for api, avoids automatic generation of guest customer with each request to api
