...
namespace Nop.Plugin.Api.Infrastructure
{
    ...
    public class ApiStartup : INopStartup
    {
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var apiConfigSection = configuration.GetSection("ApiConfiguration");

            if (apiConfigSection != null)
            {
                var apiConfig = new ApiConfiguration();// Singleton<ApiConfiguration>.Instance.Get<ApiConfiguration>();
