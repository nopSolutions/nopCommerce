...
namespace Nop.Plugin.Shipping.AustraliaPost
{
    ...
    public class AustraliaPostComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        private IList<ShippingOption> RequestShippingOptions(string countryTwoLetterIsoCode, string fromPostcode, string toPostcode, decimal weight, int length, int width, int heigth, int totalPackages)
        {
            ...
            List<String> ignoreServices = _australiaPostSettings.IgnoreServices.Split(';').ToList();
                    ...
                    try
                    {
                        ...
                        if (jToken != null)
                        {
                            ...
                            foreach (var option in options)
                            {
                                ...
                                {
                                    if (shippingOption.Name != null && !ignoreServices.Contains(shippingOption.Name))
                                    {
        ...
        public GetShippingOptionResponse GetShippingOptions(GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            try
            {
                ...
                {
                    if (country.TwoLetterIsoCode == "AU")
                    {
                        var shippingOption = new ShippingOption();
                        shippingOption.Name = "Australia Post. Standard Post";
                        shippingOption.Rate = 0.0M;
                        response.ShippingOptions.Add(shippingOption);
                    }
                }
            }
        ...
        {
            //settings
            AustraliaPostSettings settings = new AustraliaPostSettings();
            settings.IgnoreServices = "Australia Post. Small;Australia Post. Medium;Australia Post. Large;Australia Post. Extra Large";
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Shipping.AustraliaPost.Fields.IgnoreServices", "Ignore Services");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Shipping.AustraliaPost.Fields.IgnoreServices.Hint", "Enter the services to ignore, separated by ';'");
        ...
        public override void Uninstall()
        {
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.Shipping.AustraliaPost.Fields.IgnoreServices");
            _localizationService.DeletePluginLocaleResource("Plugins.Shipping.AustraliaPost.Fields.IgnoreServices.Hint");
