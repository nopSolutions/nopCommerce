...
namespace Nop.Plugin.Widgets.GoogleAnalytics
{
    ...
    public class GoogleAnalyticsPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.EnableEcommerce", "Enable eCommerce");
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.EnableEcommerce.Hint", "Check to pass information about orders to Google eCommerce feature.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.UseJsToSendEcommerceInfo", "Use JS to send eCommerce info");
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.UseJsToSendEcommerceInfo.Hint", "Check to use JS code to send eCommerce info from the order completed page. But in case of redirection payment methods some customers may skip it. Otherwise, e-commerce information will be sent using HTTP request. Information is sent each time an order is paid but UTM is not supported in this mode.");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.UseJsToSendEcommerceInfo");
            this.DeletePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.UseJsToSendEcommerceInfo.Hint");
