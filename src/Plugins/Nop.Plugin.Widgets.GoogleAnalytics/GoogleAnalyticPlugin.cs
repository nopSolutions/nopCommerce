...
namespace Nop.Plugin.Widgets.GoogleAnalytics
{
    ...
    public class GoogleAnalyticPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.TrackingScript.Hint", "Paste the tracking code generated by Google Analytics here. {GOOGLEID} and {CustomerID} will be dynamically replaced.");
