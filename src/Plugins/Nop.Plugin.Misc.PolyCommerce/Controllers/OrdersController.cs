...
namespace Nop.Plugin.Misc.PolyCommerce.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> AddOrder(PolyCommerceOrder model)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, "FirstName", "Greggo");
            _genericAttributeService.SaveAttribute(customer, "LastName", "Taylor");
            ...
            // emit 'AddNewOrder' event
            _customerActivityService.InsertActivity("AddNewOrder", _localizationService.GetResource("ActivityLog.AddNewOrder"), order);
