...
public class PaymentMomoController : BasePaymentController
{
    ...
    public PaymentMomoController(ILocalizationService localizationService,
    ...
    public async Task<IActionResult> Configure()
    {
        ...
        var manualPaymentSettings = await _settingService.LoadSettingAsync<MomoPaymentSettings>(storeScope);
