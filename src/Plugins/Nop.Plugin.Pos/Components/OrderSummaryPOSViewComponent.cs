...
{
    public partial class OrderSummaryPOSViewComponent : NopViewComponent
    {
        ...
        public OrderSummaryPOSViewComponent(IShoppingCartModelFactory shoppingCartModelFactory,
        ...
        public async Task<IViewComponentResult> InvokeAsync(bool? prepareAndDisplayOrderReviewData, ShoppingCartModel overriddenModel)
        {
            ...
            return View("~/Plugins/Pos/Views/OrderSummary.cshtml", model);
        }
    }
}
