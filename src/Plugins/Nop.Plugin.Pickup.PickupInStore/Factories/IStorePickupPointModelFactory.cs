...
namespace Nop.Plugin.Pickup.PickupInStore.Factories
{
    ...
    public interface IStorePickupPointModelFactory
    {
        ...
        Task<StorePickupPointListModel> PrepareStorePickupPointListModel(StorePickupPointSearchModel searchModel);
        ...
        Task<StorePickupPointSearchModel> PrepareStorePickupPointSearchModel(StorePickupPointSearchModel searchModel);
    }
}