...
{
    [TestFixture]
    public class LocalizedProductVariantPersistenceTests : PersistenceTest
    {
        [Test]
        public void Can_save_and_load_localizedProductVariant()
        {
            var localizedProductVariant = new LocalizedProductVariant
            {
                Name = "Name localized",
            ...
            var fromDb = SaveAndLoadEntity(localizedProductVariant);
