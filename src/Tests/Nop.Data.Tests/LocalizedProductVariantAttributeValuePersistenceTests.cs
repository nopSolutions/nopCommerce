...
{
    [TestFixture]
    public class LocalizedProductVariantAttributeValuePersistenceTests : PersistenceTest
    {
        [Test]
        public void Can_save_and_load_localizedProductVariantAttributeValue()
        {
            var lpvav = new LocalizedProductVariantAttributeValue
            {
                Name = "Name localized",
            ...
            var fromDb = SaveAndLoadEntity(lpvav);
            fromDb.Name.ShouldEqual("Name localized");

            fromDb.ProductVariantAttributeValue.ShouldNotBeNull();
            fromDb.ProductVariantAttributeValue.Name.ShouldEqual("Name 1");
