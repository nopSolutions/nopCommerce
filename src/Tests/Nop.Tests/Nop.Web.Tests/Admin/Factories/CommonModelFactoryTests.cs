...
public class CommonModelFactoryTests : BaseNopTest
{
    ...
    public class TestCommonModelFactory : CommonModelFactory
    {
        ...
        public TestCommonModelFactory(AppSettings appSettings, CatalogSettings catalogSettings, CurrencySettings currencySettings, IAuthenticationPluginManager authenticationPluginManager, IBaseAdminModelFactory baseAdminModelFactory, IBlogService blogService, ICategoryService categoryService, ICurrencyService currencyService, ICustomerService customerService, IDateTimeHelper dateTimeHelper, IEventPublisher eventPublisher, IExchangeRatePluginManager exchangeRatePluginManager, IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor, ILanguageService languageService, ILocalizationService localizationService, ILogger logger, IMaintenanceService maintenanceService, IManufacturerService manufacturerService, IMeasureService measureService, IMultiFactorAuthenticationPluginManager multiFactorAuthenticationPluginManager, INopDataProvider dataProvider, INopFileProvider fileProvider, INopUrlHelper nopUrlHelper, IOrderService orderService, IPaymentPluginManager paymentPluginManager, IPickupPluginManager pickupPluginManager, IPluginService pluginService, IProductService productService, IReturnRequestService returnRequestService, ISearchTermService searchTermService, IServiceCollection serviceCollection, IShippingPluginManager shippingPluginManager, ISmsPluginManager smsPluginManager, IStaticCacheManager staticCacheManager, IStoreContext storeContext, IStoreService storeService, ITaxPluginManager taxPluginManager, IThumbService thumbService, ITopicService topicService, IUrlRecordService urlRecordService, IWebHelper webHelper, IWidgetPluginManager widgetPluginManager, IWorkContext workContext, LinkGenerator linkGenerator, MeasureSettings measureSettings, NopHttpClient nopHttpClient, ProxySettings proxySettings) : base(appSettings, catalogSettings, currencySettings, authenticationPluginManager, baseAdminModelFactory, blogService, categoryService, currencyService, customerService, dateTimeHelper, eventPublisher, exchangeRatePluginManager, httpClientFactory, httpContextAccessor, languageService, localizationService, logger, maintenanceService, manufacturerService, measureService, multiFactorAuthenticationPluginManager, dataProvider, fileProvider, nopUrlHelper, orderService, paymentPluginManager, pickupPluginManager, pluginService, productService, returnRequestService, searchTermService, serviceCollection, shippingPluginManager, smsPluginManager, staticCacheManager, storeContext, storeService, taxPluginManager, thumbService, topicService, urlRecordService, webHelper, widgetPluginManager, workContext, linkGenerator, measureSettings, nopHttpClient, proxySettings)
        {
        }
    }
}
