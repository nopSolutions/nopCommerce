    ...
    public class ExportManagerTests : ServiceTest
    {
        ...
        public void Can_export_orders_xlsx()
        {
            var orders = new List<Order>
            {
                ...
                OrderShippingNonTaxable = 7.1M,
                PaymentMethodAdditionalFeeInclTax = 8.1M,
                PaymentMethodAdditionalFeeExclTax = 9.1M,
                PaymentMethodAdditionalFeeNonTaxable = 9.1M,
                TaxRates = "1,3,5,7",
                OrderTax = 10.1M,
                OrderDiscount = 11.1M,
                OrderDiscountIncl = 11.1M,
                OrderTotal = 12.1M,
                OrderAmount = 12.1M,
                OrderAmountIncl = 13.1M,
                EarnedRewardPointsBaseAmountExcl = 13.1M,
                EarnedRewardPointsBaseAmountIncl = 13.1M,
