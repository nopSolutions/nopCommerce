...
/// <summary>
/// Represent the range max client validator
/// </summary>
public partial class RangeMaxClientValidator : ClientValidatorBase
{
    #region Ctor
    ...
    public override void AddValidation(ClientModelValidationContext context)
    {
        ...
        context.Attributes.TryAdd("data-val-range-max", Convert.ToString(rangeValidator.ValueToCompare, CultureInfo.InvariantCulture));
        context.Attributes.TryAdd("data-val-range-min", "0");
    }
